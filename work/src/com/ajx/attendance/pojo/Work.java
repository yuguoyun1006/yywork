...
public class Work implements java.io.Serializable {
	...
	private String zhongBan;
	private String shenBan;
	...
	/** full constructor */
	public Work(String id, String name, Date attendanceDate,
			String remark, Integer deptId, String empNo, String zhongBan,
			String shenBan, Date createTime, Date updateTime,
			...
			String a27, String a28, String a29, String a30, String a31) {
		this.id = id;
		this.name = name;
	...
	public String getShenBan() {
		return this.shenBan;
	}

	public void setShenBan(String shenBan) {
		this.shenBan = shenBan;
	}
