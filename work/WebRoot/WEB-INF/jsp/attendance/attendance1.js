...
var grid;
function list(data){
    grid=$('#reportTable').bootstrapTable('destroy').bootstrapTable({
	method: 'get',
//  url: 'user/list',
	data:data,
	dataType: "json",
...
// 'json', 'xml', 'png', 'csv', 'txt', 'sql', 'doc', 'excel', 'powerpoint', 'pdf' //pdf png需要另外引js
	...
	columns: [{title: '操作',field: 'id',align: 'center',valign:'middle',width:'100',formatter:function(value,row,index){  
        ...
        default:
       ...
       },{field: 'status',title: '审核状态',width:'60',align:'center',valign:'middle',formatter:function(value,row,index){
     	  switch(value){
    	  ...
    	  default:return '未提交';break;
	          ...
	          {field: 'name',title: '姓名',width:'100',align:'center',valign:'middle'}, 
	          {field: 'attendance_date',title: '年月份',width:'60',align:'center',valign:'middle',formatter:function(value){
	        	  return new Date(value).Format('yyyy-MM');
	          }}, 
	          {field: 'emp_no',title: '工号',align:'center',valign:'middle',width:'90'},
	          {field: 'day_work',title: '类型',align:'center',valign:'middle',width:'60'},
...
// alert(data);
    ...
    for(var k=0;k<data.length;k++){
    	if(k%2==0){
    		 $('#reportTable').bootstrapTable('mergeCells',{ index: k, field: 'status', colspan: 1, rowspan:2});
    		 $('#reportTable').bootstrapTable('mergeCells',{ index: k, field: 'id', colspan: 1, rowspan:2});
    		 $('#reportTable').bootstrapTable('mergeCells',{ index: k, field: 'name', colspan: 1, rowspan:2});
    		 $('#reportTable').bootstrapTable('mergeCells',{ index: k, field: 'attendance_date', colspan: 1, rowspan:2});
    		 $('#reportTable').bootstrapTable('mergeCells',{ index: k, field: 'emp_no', colspan: 1, rowspan:2});
    	}
    }
}
/** 刷新页面 */ 
